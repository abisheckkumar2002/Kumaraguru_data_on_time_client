...
import { getmicrodata,getmicroviewdata  } from "../../actions/users";
...
return startdate;
  ...
  const getUserData = async () => {
    var test = await getmicroviewdata(id);
    ...
    formdata["exercise"] = test.userValue.excercise;
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Microcourse</h4>
              <p className={classes.cardCategoryWhite}>view Microcourse Details</p>
            </CardHeader>
            <CardBody>
