...
import { addmicrovideo,getsubjectlist,getexamlist,getclasslist,videoadd,getmicrovideodata,deletefile,gettopiclist,getfreelist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addmicrovideo(reqData);
...
const userData = async() =>{
  ...
  const listdata=await getmicrovideodata(id);
