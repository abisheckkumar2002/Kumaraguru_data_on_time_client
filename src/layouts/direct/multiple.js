...
import { adddirectt,getexamlist,getclasslist,videoadd,getlivecoursevideodata,deletefile,gettopiclist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await adddirectt(reqData);
