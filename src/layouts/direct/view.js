...
import { getdirectdata,getdirectviewdata  } from "../../actions/users";
...
return startdate;
  ...
  const getUserData = async () => {
    var test = await getdirectviewdata(id);
    ...
    formdata["introduction"] = test.userValue.validity;
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Direct</h4>
              <p className={classes.cardCategoryWhite}>view Directcourse Details</p>
            </CardHeader>
            <CardBody>
