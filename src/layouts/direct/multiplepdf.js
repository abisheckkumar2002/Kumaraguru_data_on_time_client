...
import { adddirectpdf,addfile,getdirectcoursepdfdata,deletefile,getsubjectlist,getexamlist,getclasslist,gettopiclist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await adddirectpdf(reqData);
...
const userData = async() =>{
  ...
  const listdata=await getdirectcoursepdfdata(id);
