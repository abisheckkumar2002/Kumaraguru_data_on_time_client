...
import { getdirectdata, updatedirect,getexamlist,getsubjectlist,getclasslist,gettestsetlist } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await updatedirect(reqData,id);
  ...
  const userData = async() =>{
    var test = await getdirectdata(id);
