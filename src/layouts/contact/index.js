...
import { getcontactlist,deletecontact } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/contactadd"
  }
  function editR(id) {
    if (id != "") {
      window.location ="/admin/contactedit/"+id;
    }
  }
  function viewR(id) {
    if (id != "") {
