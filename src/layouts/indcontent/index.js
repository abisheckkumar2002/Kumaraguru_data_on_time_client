...
import { getindlist,deleteindcontent } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/addindcontent"
  }
  function editR(id) {
    if (id != "") {
      window.location ="/indcontentedit/"+id;
    }
  }
  function viewR(id) {
    if (id != "") {
      window.location ="/indcontentview/"+id;
    }
  }
  ...
  function deleteR(id) {
    if (id != "") {
      ...
      history("/indcontentindex");
      window.location = "/indcontentlist";
    }
  }

  const getUserListdata = async () => {
    var test = await getindlist();
