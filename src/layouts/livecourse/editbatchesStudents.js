...
import { getlivecoursedata,getunallotedstudentsinbatchlist,livecoursebatchstudentadd,deletelivecourse } from "../../actions/users";
...
// console.log(selectedStudents,"vfdgfdfgdfg")
  ...
  const getUserListdata = async () => {
    ...
    const mapped = await Promise.all(test.userValue.map(element =>Object.assign(element, {
      action: (
        <>
                 <Checkbox {...label} onChange={()=>selectStudent(element.user_id)}/>
               </>
      )
    }
