...
import { addlivecoursee,getexamlist,getclasslist,videoadd,getlivecoursevideodata,deletefile,gettopiclist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addlivecoursee(reqData);
...
const userData = async() =>{
  ...
  const listdata=await getlivecoursevideodata(id);
