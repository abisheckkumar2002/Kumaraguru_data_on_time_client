...
import { getlivecourseviewdata,  } from "../../actions/users";
...
return startdate;
  ...
  const getUserData = async () => {
    var test = await getlivecourseviewdata(id);
    console.log(test.userValue,"ssss");
    let formdata = {};
    ...
    formdata["introduction"] = test.userValue.introduction;
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Livecourse</h4>
              <p className={classes.cardCategoryWhite}>view Livecourse Details</p>
            </CardHeader>
            <CardBody>
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Target exam" }}>{targetexam}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Start date" }}>{datealignment(startdate)}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "End date" }}>{datealignment(enddate)}</Box>
                </GridItem> 
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "validity" }}>{validity}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Total classes" }}>{totalclasses}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Total test" }}>{totaltest}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Total pdf" }}>{totalpdf}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Total questions" }}>{totalquestions}</Box>
                </GridItem> */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Title" }}>{removeTags(description)}</Box>
                </GridItem>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Introduction" }}>{removeTags(introduction)}</Box>
                </GridItem>
