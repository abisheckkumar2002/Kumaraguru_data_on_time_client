...
import { livecoursebatchadd ,getsubjectlist,getexamlist,getclasslist,getliveteacherlist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await livecoursebatchadd  (reqData);
...
function getStyles(name, personName, theme) {
  ...
  return (
    ...
    />
                  ...
                  <GridItem xs={12} sm={12} md={4}>
                  <InputLabel id="teachersLabel">Teachers <span style={{ color:"red", fontSize:"13px" }}>(Multiple Select)</span> </InputLabel>
                      <Select
