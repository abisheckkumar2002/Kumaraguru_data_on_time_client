...
import { gettrendingvideolist,deletetrendingvideo } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/trendingvideoadd"
  }
  ...
  function editR(id) {
    if (id != "") {
      window.location ="/admin/trendingvideoedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await gettrendingvideolist();
