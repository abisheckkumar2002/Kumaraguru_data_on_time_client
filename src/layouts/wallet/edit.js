...
import { getwallet, updatewallet } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    console.log(reqData);
    let { error } = await updatewallet(reqData,id);
    console.log("error", error);
    if (isEmpty(error)) {
      toast.success("User Updated", toasterOption);
      history("/wallettindex");
    } else {
  ...
  const getUserData = async () => {
    ...
    data["percentage"] = test.userValue.percentage;
    data["studentpercentage"] = test.userValue.studentpercentage;
          ...
          <Card>
            ...
            >
              ...
              <GridContainer>
                  ...
                  <GridItem xs={12} sm={12} md={4}>
                    <CustomInput
                      labelText="Percentage for referrer in %"
                      onChange={onChange}
                      value={percentage}
                      id="percentage"
                      formControlProps={{
                  ...
                  <GridItem xs={12} sm={12} md={4}>
                    <CustomInput
                      labelText="Percentage for student in %"
                      onChange={onChange}
