...
import { gettestseriesdata, updatetestseries,getexamlist,getsubjectlist,getclasslist,gettestsetlist } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const userData = async() =>{
    var test = await gettestseriesdata(id);
    ...
    formdata["testsets"] = test.userValue.testsets;
