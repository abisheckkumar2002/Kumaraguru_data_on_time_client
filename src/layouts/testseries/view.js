...
import { gettestseriesdata,gettestseriesviewdata  } from "../../actions/users";
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Testseries</h4>
              <p className={classes.cardCategoryWhite}>view Testseries Details</p>
            </CardHeader>
            <CardBody>
 ...
 */}
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "testsets" }}>{testsets}</Box>
                </GridItem>
