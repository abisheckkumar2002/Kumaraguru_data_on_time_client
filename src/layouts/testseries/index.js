...
import { gettestserieslist,deletetestseries } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/testseriesadd"
  }
  ...
  function viewR(id) {
    if (id != "") {
      window.location ="/admin/testseriesview/"+id;
    }
  }

  function editR(id) {
    if (id != "") {
      window.location ="/admin/testseriesedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await gettestserieslist();
