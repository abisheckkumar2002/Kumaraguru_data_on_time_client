...
import { getaboutdata, updateabout } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleProcedureContentChange = (
    ...
    let formData = { ...formValue, ...{ ["team"]: contentsatta } };
  ...
  const handleFormSubmit = async (e) => {
    ...
    console.log(reqData);
    let { error } = await updateabout(reqData, id);
  ...
  const getUserData = async () => {
    ...
    formdata["team"] = removeTags(test.userValue.team);
              ...
              >
                ...
                <CardBody>
                  <GridContainer>
                    <GridItem xs={12} sm={12} md={4}>
                      ...
                      <InputLabel style={{ color: "red", fontSize: "13px" }}>
                        178*162(Recommended image size)
                      </InputLabel>
                    </GridItem>
                  ...
                  <GridItem xs={12} sm={12} md={4}>
                    ...
                    <GridItem xs={12} sm={12} md={12}>
                      <InputLabel>Testimonial content</InputLabel>
                      <ReactQuill
                        theme="snow"
                        modules={modules}
                        formats={formats}
