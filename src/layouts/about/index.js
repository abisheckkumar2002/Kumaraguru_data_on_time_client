...
import { getaboutlist,deleteabout } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/addabout"
  }
  ...
  function viewR(id) {
    if (id != "") {
      window.location ="/admin/aboutview/"+id;
    }
  }

  function editR(id) {
    if (id != "") {
      window.location ="/admin/aboutedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await getaboutlist();
