...
import { getstorylist,deletecompany } from "../../actions/users";
...
function Item() {
  ...
  function editR(id) {
    if (id != "") {
      window.location ="/storyedit/"+id;
    }
  }
  function viewR(id) {
    if (id != "") {
      window.location ="/companyview/"+id;
    }
  }
  ...
  function deleteR(id) {
    if (id != "") {
      ...
      window.location = "/companyindex";
    }
  }
  const getUserListdata = async () => {
    var test = await getstorylist();
