...
import { getstory, updatestory } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    console.log(reqData);
    let { error } = await updatestory(reqData,id);
          ...
          <Card>
            ...
            >
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>Edit Story</h4>
                <p className={classes.cardCategoryWhite}>update the story</p>
              </CardHeader>
              <CardBody>
              <GridContainer>
