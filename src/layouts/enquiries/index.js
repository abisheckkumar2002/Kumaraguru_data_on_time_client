...
import { getenquirylist,deleteenquiry } from "../../actions/users";
...
function Item() {
  ...
  function editR(id) {
    if (id != "") {
      window.location ="/admin/enquiryedit/"+id;
    }
  }

  function viewR(id) {
    if (id != "") {
      window.location ="/admin/enquiryview/"+id;
    }
  }
