...
import { getcompany, updatecompany } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    console.log(reqData);
    let { error } = await updatecompany(reqData,id);
    console.log("error", error);
    if (isEmpty(error)) {
      toast.success("Updated", toasterOption);
      history("/companyindex");
    } else {
          ...
          <Card>
            ...
            >
              <CardHeader color="primary">
                ...
                <p className={classes.cardCategoryWhite}>update the company</p>
              </CardHeader>
              <CardBody>
              <GridContainer>
