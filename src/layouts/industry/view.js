...
import { getindustrie,  } from "../../actions/users";
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Industry</h4>
              <p className={classes.cardCategoryWhite}>view Industry Details</p>
            </CardHeader>
            <CardBody>
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={9}>
                  <Box sx={{ typography: "body1" }}>{description}</Box>
                </GridItem>
              </GridContainer>
