...
import { getscholarshipdata, updatescholarship,getexamlist,getsubjectlist,getclasslist } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await updatescholarship(reqData,id);
  ...
  const userData = async() =>{
    var test = await getscholarshipdata(id);
