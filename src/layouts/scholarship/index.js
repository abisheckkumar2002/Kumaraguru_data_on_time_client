...
import { getscholarshiplist,deletescholarship } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/scholarshipadd"
  }
  ...
  function viewR(id) {
    if (id != "") {
      window.location ="/admin/scholarshipview/"+id;
    }
  }

  function editR(id) {
    if (id != "") {
      window.location ="/admin/scholarshipedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await getscholarshiplist();
