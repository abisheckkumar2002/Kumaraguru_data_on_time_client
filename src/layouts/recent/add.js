...
import { addstudy } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addstudy(reqData);
    console.log("error", error);
    if (isEmpty(error)) {
      toast.success("Study added", toasterOption);
      history("/studyindex");
    } else {
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            ...
            >
              ...
              <MDTypography>
                <h3 className={classes.cardTitleWhite}>Manage Studies</h3>
                </MDTypography>
              </CardHeader>
              <CardBody>
                <GridContainer>
