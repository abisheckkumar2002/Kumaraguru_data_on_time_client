          ...
          <Card>
            ...
            <CardBody>
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "description" }}>  {removeTags(description)}
</Box>
                </GridItem>

                <GridItem xs={12} sm={12} md={3}>
                  <Typography noWrap className={classes.description2}>
                    Content
                  </Typography>
                </GridItem>
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "description2" }}> {removeTags(description2)}</Box>
                </GridItem>

                <GridItem xs={12} sm={12} md={3}>
                  <Typography noWrap className={classes.description3}>
                    Content
                  </Typography>
                </GridItem>
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "description3" }}> {removeTags(description3)}</Box>
                </GridItem>
