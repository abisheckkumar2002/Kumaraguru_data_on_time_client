...
import { getrecordeddata, updaterecorded,getexamlist,getsubjectlist,getclasslist,gettestsetlist } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await updaterecorded(reqData,id);
  ...
  const userData = async() =>{
    var test = await getrecordeddata(id);
