...
import { addrecordpdf,gettopiclist,getsubjectlist,getexamlist,getclasslist,addfile,getrecordedpdfdata,deletefile,getfreelist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addrecordpdf(reqData);
...
const userData = async() =>{
  ...
  setfreeopt(options4)
  const listdata=await getrecordedpdfdata(id);
