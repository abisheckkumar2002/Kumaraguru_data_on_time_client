...
import { addrecordvideo,gettopiclist,getsubjectlist,getexamlist,getclasslist,videoadd,getrecordedvideodata,deletefile,getfreelist } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addrecordvideo(reqData);
