...
import { getrecordeddata,getrecordedviewdata  } from "../../actions/users";
...
return startdate;
  ...
  const getUserData = async () => {
    var test = await getrecordedviewdata(id);
    console.log(getrecordeddata,"sss")
    let formdata = {};
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Recorded course</h4>
              <p className={classes.cardCategoryWhite}>View Recorded course Details</p>
            </CardHeader>
            <CardBody>
            ...
            <GridContainer>
                ...
                {/* <GridItem xs={12} sm={12} md={3}>
                  <Typography noWrap className={classes.validity}>
                    Validity
                  </Typography>
                </GridItem>
                <GridItem xs={12} sm={12} md={3}>
