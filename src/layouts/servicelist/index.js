...
import { servicedetaillist,deleteservicedetail } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/servicedetailadd"
  }
  function deleteR(id) {
    if (id != "") {
      ...
      window.location = "/servicedetailindex";
    }
  }
  function viewR(id) {
    if (id != "") {
      window.location ="/servicedetailview/"+id;
    }
  }

  function editR(id) {
    if (id != "") {
      window.location ="/admin/servicedetailedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await servicedetaillist();
