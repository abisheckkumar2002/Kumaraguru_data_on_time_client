...
import { getagentearninglist } from "../../actions/users";
...
function Item() {
  ...
  const columns= [
    { 
      Header: "Agent's earning courses", 
      accessor: "comments", 
      align: "left" 
    },
    { 
  ...
  function editR(id) {
    if (id != "") {
      window.location ="/admin/agentstatusedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await getagentearninglist(id);
