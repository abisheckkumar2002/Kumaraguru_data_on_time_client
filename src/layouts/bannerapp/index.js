...
import { getbannerapplist,deletebanner } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/bannerappadd"
  }
  ...
  function viewR(id) {
    if (id != "") {
      window.location ="/admin/bannerappview/"+id;
    }
  }

  function editR(id) {
    if (id != "") {
      window.location ="/admin/bannerappedit/"+id;
    }
  }

  const getUserListdata = async () => {
    var test = await getbannerapplist();
