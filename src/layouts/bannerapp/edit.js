...
import { getbannerdata, updateappbanner } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    console.log(reqData);
    let { error } = await updateappbanner(reqData,id);
            ...
            >
              ...
              <GridContainer>
                <GridItem xs={12} sm={12} md={4}>
                    ...
                    />
                      {image ? <img src={config.API + "/images/user/" + image} alt="..." style={{ maxWidth: 50, maxHeight: 50 }} />:null}
                    {validateError.image && (
