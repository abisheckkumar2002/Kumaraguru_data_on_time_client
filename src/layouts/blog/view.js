...
import { getblog,  } from "../../actions/users";
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Blog</h4>
              <p className={classes.cardCategoryWhite}>view Blog Details</p>
            </CardHeader>
            <CardBody>
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "heading" }}>{heading}</Box>
                </GridItem>
              </GridContainer>
