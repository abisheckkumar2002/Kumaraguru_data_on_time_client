...
import { getmissionlist,deleteeducontent } from "../../actions/users";
...
function Item() {
  ...
  function editR(id) {
    if (id != "") {
      window.location ="/admin/missionedit/"+id;
    }
  }
  function viewR(id) {
    if (id != "") {
  ...
  const getUserListdata = async () => {
    var test = await getmissionlist();
    console.log(test,"hghg");
          ...
          <Grid item xs={12}>
            <Card>
              ...
              <MDTypography variant="h6" color="white">
                 Edit Marvel Classes Advantages
                </MDTypography>
              </MDBox>
              <MDBox pt={3}>
                <DataTable
