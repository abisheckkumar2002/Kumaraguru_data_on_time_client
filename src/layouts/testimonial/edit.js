...
import { gettestimonial, updatetestimonial } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    console.log(reqData);
    let { error } = await updatetestimonial(reqData,id);
    console.log("error", error);
    if (isEmpty(error)) {
      toast.success("Updated", toasterOption);
      history("/testimonialindex");
    } else {
          ...
          <Card>
            ...
            >
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>Edit Testimonial</h4>
                <p className={classes.cardCategoryWhite}>update the testimonial</p>
              </CardHeader>
              <CardBody>
              <GridContainer>
