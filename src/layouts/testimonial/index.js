...
import { gettestimoniallist,deletetestimonial } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/testimonialadd"
  }
  function editR(id) {
    if (id != "") {
      window.location ="/testimonialedit/"+id;
    }
  }
  function viewR(id) {
    if (id != "") {
      window.location ="/testimonialview/"+id;
    }
  }
  ...
  function deleteR(id) {
    if (id != "") {
      ...
      toast.success("deleted success");
       history("/bannerindex");
      window.location = "/testimonialindex";
    }
  }

  const getUserListdata = async () => {
    var test = await gettestimoniallist();
