...
import { getlogodata,  } from "../../actions/users";
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Logo</h4>
              <p className={classes.cardCategoryWhite}>view Logo Details</p>
            </CardHeader>
            <CardBody>
