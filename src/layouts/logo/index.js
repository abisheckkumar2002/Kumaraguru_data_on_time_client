...
import { getlogolist,deletelogo } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/logoadd"
  }
  function editR(id) {
    if (id != "") {
      window.location ="/admin/logoedit/"+id;
    }
  }
  function viewR(id) {
    if (id != "") {
      window.location ="/logoview/"+id;
    }
  }
