...
import { addfreestuffvideo,getsubjectlist,gettopiclist,getexamlist,getclasslist,videoadd,getfreestuffvideodata,deletefile } from "actions/users";
...
export default function UserProfile() {
  ...
  const [inputList, setInputList] = useState([{ image: "",title: "",description: "", file: "",topicid:""}]);
  const { id } = useParams();
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addfreestuffvideo(reqData);
    ...
    const handleAddClick = () => {
      setInputList([...inputList, { image: "",title: "",description: "", file: "",topicid:""}]);
    };
const userData = async() =>{
  ...
  const listdata=await getfreestuffvideodata(id);

  console.log(listdata,"ssssa")
