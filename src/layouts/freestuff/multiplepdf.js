...
import { addfreestuffpdf,gettopiclist,getsubjectlist,getexamlist,getclasslist,addfile,getfreestuffpdfdata,deletefile } from "actions/users";
...
export default function UserProfile() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let { error } = await addfreestuffpdf(reqData);
...
const userData = async() =>{
  ...
  const listdata=await getfreestuffpdfdata(id);
