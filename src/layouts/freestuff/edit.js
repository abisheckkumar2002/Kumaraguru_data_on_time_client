...
import { getfreestuffdata, updatefreestuff, getexamlist, getsubjectlist, getclasslist, gettestsetlist } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const handleProcedureContentChange = (contentsatta, delta, source, editor) => {
    ...
    console.log(contentsatta,"bbbbb");
  ...
  const handleFormSubmit = async (e) => {
    ...
    let reqData = {
      ...
      classs: eligiblity.value,
      testsets,
    };
    console.log(reqData, "sss");
    let { error } = await updatefreestuff(reqData, id);
  ...
  const userData = async () => {
    var test = await getfreestuffdata(id);
    console.log(test, "ffffs");
    let formdata = {};
    ...
    formdata["classs"] = test.userValue.class;
    ...
    formdata["eligiblity"] = options2.find(e => e.value == test.userValue.class);
