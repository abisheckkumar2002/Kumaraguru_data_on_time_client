...
import { getfreestuffdata,getfreestuffviewdata  } from "../../actions/users";
...
export default function UserProfile(props) {
  ...
  const getUserData = async () => {
    var test = await getfreestuffviewdata(id);
    ...
    formdata["classs"] = test.userValue.classs;
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>View Freestuff</h4>
              <p className={classes.cardCategoryWhite}>view Freestuff Details</p>
            </CardHeader>
            <CardBody>
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Eligiblity" }}>{classs}</Box>
                </GridItem>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <Box sx={{ typography: "Description" }}>{removeTags(description)}</Box>
                </GridItem>
