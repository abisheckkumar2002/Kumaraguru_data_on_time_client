...
import { getsubjectrespectlist,deletesubjectrespect } from "../../actions/users";
...
function Item() {
  ...
  const add =()=>{
    window.location = "/admin/freestufffolder/"+id;
  }
  function editR(id) {
    if (id != "") {
      window.location ="/admin/respectsubjectedit/"+id;
    }
  }
  ...
  const getUserListdata = async () => {
    var test = await getsubjectrespectlist(id);
